...
public class PropertyRestrictionCategoryServiceImpl implements IPropertyRestrictionCategoryService {
	...
	/**
     * Deletes a property restriction category by its ID.
     *
     * @param categoryId The ID of the property restriction category to delete.
     */
	...
	/**
     * Retrieves all category types of property restriction categories.
     *
