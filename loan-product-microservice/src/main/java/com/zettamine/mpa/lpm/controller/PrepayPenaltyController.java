...
public class PrepayPenaltyController {
     ...
     *
     * @param penalityDto The DTO containing information about the Prepay Penalty to be created.
     ...
     *
     * @param penalityDto The DTO containing updated information about the Prepay Penalty.
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
     ...
     *
     * @param prodId The ID of the Loan Product for which Prepay Penalty status needs to be updated.
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
     ...
     *
     * @param prodId The ID of the Loan Product for which Prepay Penalty details need to be fetched.
     * @return ResponseEntity<PrepayPenaltyStatusDto> HTTP response containing DTO representation of Prepay Penalty details.
     */
