...
public class LoanProductController {
     ...
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
    @Operation(summary = "Add Property Restrictions To Loan Product By Loan Product Id", description = "REST API to Add Property Restrictions To Loan Product By Loan Product Id")
    @ApiResponses({ @ApiResponse(responseCode = "201", description = "HTTP Status CREATED"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
     ...
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
    @Operation(summary = "Remove Property Restrictions Of a Loan Product By Loan Product Id", description = "REST API to Remove Property Restrictions of  Loan Product Based on Loan Product Id" )
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
     ...
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
    @Operation(summary = "Remove Escrow Requirements Of a Loan Product By Loan Product Id", description = "REST API to Remove Escrow Requirements of  Loan Product Based on Loan Product Id" )
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
     ...
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
    @Operation(summary = "Add Escrow Requirements Of a Loan Product By Loan Product Id", description = "REST API to Add Escrow Requirements of  Loan Product Based on Loan Product Id" )
    @ApiResponses({ @ApiResponse(responseCode = "201", description = "HTTP Status CREATED"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
     ...
     * @return ResponseEntity<?> HTTP response indicating the status of the operation.
     */
    @Operation(summary = "Add Underwriting Criteria Of a Loan Product By Loan Product Id", description = "REST API to Add Underwriting Criteria of  Loan Product Based on Loan Product Id" )
    @ApiResponses({ @ApiResponse(responseCode = "201", description = "HTTP Status CREATED"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
