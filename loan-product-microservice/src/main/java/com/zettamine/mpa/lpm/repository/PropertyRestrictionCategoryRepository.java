...
/**
 * This interface represents a repository for managing PropertyRestrictionCategory entities, which define categories of property restrictions.
...
public interface PropertyRestrictionCategoryRepository extends JpaRepository<PropertyRestrictionCategory, Serializable> {
     ...
     * @return an Optional containing the PropertyRestrictionCategory if found, or empty if not found
     */
     ...
     *
     * @return a List containing all category types of property restriction categories
     */
