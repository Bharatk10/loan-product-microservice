...
@Repository
/**
 * This interface represents a repository for managing PropertyRestriction entities, which define various types of property restrictions.
...
public interface PropertyRestrictionRepository extends JpaRepository<PropertyRestriction, Serializable> {
     ...
     * @return an Optional containing the PropertyRestriction if found, or empty if not found
     */
