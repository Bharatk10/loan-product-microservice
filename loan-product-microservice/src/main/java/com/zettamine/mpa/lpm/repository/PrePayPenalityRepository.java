...
/**
 * This interface represents a repository for managing PrepayPenalty entities related to loan product prepayment penalties.
...
public interface PrePayPenalityRepository extends JpaRepository<PrepayPenalty, Serializable> {
     ...
     * @param active the status of the loan product (usually represented by a character, e.g., 'Y' for active)
