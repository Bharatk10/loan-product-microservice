...
public class PropertyRestrictionController {
	 ...
	 private IPropertyRestrictionService restrService;
	     ...
	     *
	     * @param rstrDto The DTO containing information about the Property Restriction to be created.
	     * @return ResponseEntity<ResponseDto> HTTP status and message indicating the result of the operation.
	     */
	     ...
	     * @param rstrDto The DTO containing updated information about the Property Restriction.
	     * @return ResponseEntity<ResponseDto> HTTP status and message indicating the result of the operation.
	     */
	     ...
	     * @return ResponseEntity<PropertyRestrictionDto> HTTP status and DTO representation of the retrieved Property Restriction.
	     */
	     ...
	     *
	     * @return ResponseEntity<List<PropertyRestrictionDto>> HTTP status and list of DTO representations of all Property Restrictions.
	     */
	     ...
	     *
	     * @return ResponseEntity<List<String>> HTTP status and list of all Property Restriction types.
	     */
	     ...
	     * @return ResponseEntity<?> HTTP status and message indicating the result of the operation.
	     */
